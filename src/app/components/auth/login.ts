      ...
      <div class="w-full max-w-md">
        ...
        >
          ...
          >
            <div class="space-y-3">
              <div class="relative">
                ...
                <input
                  ...
                  placeholder="Email"
                  class="w-full pl-11 h-12 bg-gray-800/50 border border-gray-700 text-white placeholder:text-gray-500 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#00FF88] focus:border-[#00FF88] transition-all"
                />
              </div>
              <div class="relative">
                <svg
            ...
            <button
              type="button"
              class="text-sm text-[#00FF88] hover:text-[#00FF88]/80 transition-colors"
            >
              Forgot password?
            </button>
            ...
            <button
              ...
              class="w-full h-12 bg-[#00FF88] hover:bg-[#00FF88]/90 text-black rounded-lg transition-colors font-medium flex items-center justify-center gap-2 disabled:opacity-50"
            >
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
          By continuing, you agree to Finmate's Terms of Service and Privacy
          Policy
        </p>
      </div>
    </div>
