      ...
      <div class="w-full max-w-md">
        <div class="text-center mb-8">
          <div class="mb-4 flex justify-center">
            <div
              class="w-24 h-24 rounded-3xl bg-gradient-to-tr from-[#00FF88] to-emerald-600 flex items-center justify-center shadow-lg shadow-[#00FF88]/20"
            >
        ...
        <div
          class="bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-800 p-8"
        >
          <form
          ...
          >
            <div class="grid grid-cols-2 gap-3">
              <input
                ...
                class="h-12 bg-gray-800/50 border border-gray-700 text-white placeholder:text-gray-500 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#00FF88] focus:border-[#00FF88]"
              />
              <input
                type="text"
            ...
            <input
              ...
              placeholder="Email"
              class="w-full h-12 bg-gray-800/50 border border-gray-700 text-white placeholder:text-gray-500 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#00FF88] focus:border-[#00FF88]"
            />
            <input
              type="password"
            ...
            <button
              ...
              class="w-full h-12 bg-[#00FF88] hover:bg-[#00FF88]/90 text-black rounded-lg transition-colors font-medium disabled:opacity-50"
            >
          ...
          <p class="text-center text-sm text-gray-400 mt-6">
            ...
            <a
              ...
              class="text-[#00FF88] hover:text-[#00FF88]/80 transition-colors"
              >Sign in</a
            >
          </p>
        </div>
  ...
  private handleGoogleCallback(response: any) {
    this.ngZone.run(() => {
      ...
      this.authService.googleLogin(response.credential).subscribe({
        ...
        error: (err) => {
          this.error =
            err.error?.error || 'Google sign-up failed. Please try again.';
          this.googleLoading = false;
        },
      });
    });
