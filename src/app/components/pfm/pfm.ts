  ...
  template: `
    <app-main-layout pageTitle="Personal Finance" activePage="pfm">
      <div class="flex flex-col h-full">
        <div
          class="p-4 bg-gray-900/50 backdrop-blur-md sticky top-0 z-10 border-b border-gray-800"
        >
          ...
          <div class="flex gap-2">
            @for (tab of tabs; track tab) {
              <button
                (click)="activeTab = tab"
                class="flex-1 py-2 px-3 rounded-xl text-sm font-medium transition-all"
                [class]="
                  activeTab === tab
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-6">
          @if (activeTab === 'Overview' && overview) {
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-3">
              <div
                class="bg-gray-900/50 p-4 rounded-2xl border border-gray-800"
              >
                ...
                <div class="text-xl font-bold text-white">
                  {{
                    overview.incomeMtd | currency: 'USD' : 'symbol' : '1.2-2'
                  }}
                </div>
              </div>
              <div
              ...
              >
                ...
                <div class="text-xl font-bold text-white">
                  {{
                    overview.expensesMtd | currency: 'USD' : 'symbol' : '1.2-2'
                  }}
                </div>
              </div>
              <div
                class="bg-gray-900/50 p-4 rounded-2xl border border-gray-800 col-span-2 lg:col-span-1"
              >
                <div class="flex items-center gap-2 mb-2 text-gray-400 text-xs">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="flex flex-col sm:flex-row items-center gap-4">
                <div class="h-40 w-40 flex-shrink-0 relative">
                  <div
                    ...
                    style="background: conic-gradient(#00FF88 0% 48%, #00CC6A 48% 66%, #009950 66% 78%, #006635 78% 86%, #004422 86% 100%)"
                  ></div>
                  <div
                    class="absolute inset-0 flex items-center justify-center flex-col"
                  >
                    <div
                      class="w-20 h-20 rounded-full bg-gray-900 flex items-center justify-center flex-col"
                    >
                  ...
                  @for (seg of overview.expenseSegments; track seg.category) {
                    <div class="flex items-center justify-between text-sm">
                      ...
                      <span class="font-medium text-white">{{
                        seg.amount | currency: 'USD' : 'symbol' : '1.0-0'
                      }}</span>
                    </div>
                  }
                </div>
          ...
          @if (activeTab === 'Transactions') {
            <div class="space-y-3">
              @for (tx of transactions; track tx.id) {
                <div
                  class="flex items-center justify-between p-3 bg-gray-900/50 rounded-2xl border border-gray-800"
                >
                  <div>
                  ...
                  <div class="text-right">
                    <div
                      class="font-medium"
                      [class]="
                        tx.type === 'Income' ? 'text-[#00FF88]' : 'text-red-400'
                      "
                    >
                      {{ tx.type === 'Income' ? '+' : '-'
          ...
          @if (activeTab === 'Goals') {
            <div class="flex items-center justify-between">
              ...
              <button
                (click)="openGoalModal()"
                class="flex items-center gap-1 text-[#00FF88] text-sm font-medium hover:text-[#00FF88]/80 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
            ...
            <div class="space-y-4">
              @for (goal of goals; track goal.id) {
                <div
                  class="p-4 bg-gray-900/50 rounded-2xl border border-gray-800"
                >
                  <div class="flex items-start gap-3 mb-3">
                    <div
                      class="w-10 h-10 rounded-xl bg-gray-800 flex items-center justify-center text-xl flex-shrink-0"
                    >
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-semibold text-[#00FF88]"
                  ...
                  <div
                    class="w-full h-2.5 bg-gray-800 rounded-full overflow-hidden"
                  >
                    <div
                      class="h-full bg-[#00FF88] rounded-full transition-all duration-500"
              ...
              @if (goals.length === 0) {
                <div class="flex flex-col items-center justify-center py-12">
                  <div
                    class="w-16 h-16 rounded-2xl bg-[#00FF88]/10 flex items-center justify-center mb-4"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="28"
                  ...
                  <button
                    (click)="openGoalModal()"
                    class="px-4 py-2 bg-[#00FF88] text-black rounded-xl text-sm font-medium hover:bg-[#00FF88]/90 transition-colors"
                  >
      ...
      @if (showGoalModal) {
        ...
        >
          ...
          <div
            class="relative w-full max-w-[430px] bg-gray-900 border-t border-gray-700 rounded-t-3xl p-5 pb-8 animate-slide-up"
          ...
          >
              ...
              <div class="grid grid-cols-4 gap-2">
                @for (preset of goalPresets; track preset.name) {
                  <button
                    ...
                    [class]="
                      goalForm.value.name === preset.name
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                ...
                <input
                  type="number"
                  [formControl]="goalForm.controls.targetAmount"
                  placeholder="0.00"
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                ...
                <input
                  type="number"
                  [formControl]="goalForm.controls.currentAmount"
                  placeholder="0.00"
                  class="w-full h-11 bg-gray-800/50 border border-gray-700 text-white text-sm placeholder:text-gray-500 rounded-lg pl-7 pr-3 focus:outline-none focus:ring-2 focus:ring-[#00FF88]/50 focus:border-[#00FF88]/50 transition-all"
                />
              </div>
            ...
            <div class="mb-5">
              ...
              <input
                type="date"
                [formControl]="goalForm.controls.deadline"
            ...
            <button
              (click)="submitGoal()"
              [disabled]="
                goalForm.controls.name.invalid ||
            ...
            >
              @if (goalSaving) {
                <div
                  class="w-5 h-5 border-2 border-black border-t-transparent rounded-full animate-spin mx-auto"
                ></div>
              } @else {
                Create Goal
              }
...
export class PfmComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.getPfmOverview().subscribe((data) => {
      this.overview = data;
      this.maxCashflow = Math.max(
        ...data.cashflowData.flatMap((d) => [d.income, d.expenses]),
      );
    });
  ...
  submitGoal() {
    if (
      this.goalForm.controls.name.invalid ||
      this.goalForm.controls.targetAmount.invalid
    )
      return;
  ...
  getGoalEmoji(name: string): string {
    const preset = this.goalPresets.find(
