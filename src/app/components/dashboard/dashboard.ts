      ...
      @if (data) {
        <div class="p-4 lg:p-0 space-y-6">
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            >
              ...
              <div
                class="text-lg lg:text-xl font-semibold"
                [style.color]="netMtd() >= 0 ? '#00FF88' : '#ef4444'"
              >
            ...
            >
              ...
              <div
                class="mt-2 w-full h-1.5 rounded-full"
                style="background: var(--surface-3);"
              >
                <div
                  class="h-full rounded-full"
                  [style.width.%]="Math.max(0, Math.min(100, savingsRate()))"
                  style="background: linear-gradient(90deg, #00FF88, #06b774);"
                ></div>
              </div>
            </div>
          </div>
          ...
          <div class="grid gap-6 lg:grid-cols-3">
            <div class="lg:col-span-2 space-y-6">
              <div
                class="relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl rounded-3xl p-5 lg:p-7 border border-gray-700"
              >
                ...
                <div class="grid grid-cols-3 gap-2 relative">
                  ...
                  <button
                    ...
                    class="inline-flex items-center justify-center gap-1 py-2 px-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/30 h-10 text-xs rounded-md font-medium transition-all"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                  ...
                  <button
                    ...
                    class="inline-flex items-center justify-center gap-1 py-2 px-2 bg-[#00FF88]/20 hover:bg-[#00FF88]/30 text-[#00FF88] border border-[#00FF88]/30 h-10 text-xs rounded-md font-medium transition-all"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                  ...
                  @if (showAssetMenu) {
                    <div
                      class="absolute top-12 left-0 z-30 w-56 rounded-xl border shadow-xl overflow-hidden animate-fade-in"
                      style="background: var(--surface-modal); border-color: var(--border-1);"
                      (click)="$event.stopPropagation()"
                    >
                      <a
                        routerLink="/stocks"
                        (click)="showAssetMenu = false"
              ...
              >
                <div
                  ...
                  style="background: radial-gradient(80% 120% at 0% 0%, rgba(0,255,136,0.18), transparent 60%);"
                ></div>
                <div
                  class="relative flex items-center gap-4 p-5 lg:p-6 text-left"
                >
                  <div
                    class="flex items-center justify-center w-14 h-14 lg:w-16 lg:h-16 rounded-2xl flex-shrink-0 transition-transform duration-300 group-hover:scale-105"
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span
                        class="hidden sm:inline-flex text-[10px] font-bold tracking-wider px-2 py-0.5 rounded-md"
                        style="background: rgba(0,255,136,0.18); color: #00FF88;"
                        >EXCEL</span
                      >
                    </div>
                    <p class="text-xs lg:text-sm" style="color: var(--text-3);">
                      Multi-sheet Excel workbook — balance, transactions,
                      assets, stocks, crypto, goals and cashflow.
                    </p>
                  </div>
                  <div
                    class="hidden sm:flex w-9 h-9 rounded-full items-center justify-center transition-transform duration-300 group-hover:translate-x-1"
                ...
                @if (downloadError) {
                  <div class="px-5 pb-4 -mt-1 text-xs text-red-400 text-left">
                    {{ downloadError }}
                  </div>
                }
              </button>
            ...
            <div class="space-y-5">
              <div>
                <h2 class="text-sm mb-3" style="color: var(--text-3);">
                  Your Assets
                </h2>
                <div class="space-y-3">
                  @for (asset of data.assets; track asset.id) {
                    <a
                      [routerLink]="getAssetRoute(asset.type)"
                      class="w-full bg-gray-800/40 hover:bg-gray-800/60 border border-gray-700 rounded-2xl p-3 transition-all duration-200 hover:border-[#00FF88]/30 flex items-center gap-3"
                    >
                      <div class="text-2xl">
                        {{ getAssetEmoji(asset.type) }}
                      </div>
                      <div class="flex-1 text-left min-w-0">
                        <h3 class="text-white font-medium mb-0.5 text-sm">
                          {{ asset.name }}
                        </h3>
                        <p class="text-xl text-white font-semibold mb-1">
                          {{
                            asset.balance | currency: 'USD' : 'symbol' : '1.0-0'
                          }}
                        </p>
                        <div class="flex items-center gap-1">
                          ...
                          @if (asset.changePercent >= 0) {
                            ...
                            <span class="text-xs text-[#00FF88]"
                              >+{{
                      ...
                      <div class="w-20 h-12 flex-shrink-0">
                        ...
                        >
                          <path
                            [attr.d]="buildSparklinePath(asset.sparklineData)"
                            fill="none"
                            [attr.stroke]="
                              asset.changePercent >= 0 ? '#00FF88' : '#f87171'
                            "
                            stroke-width="2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                ...
                <div>
                  <div class="flex items-center justify-between mb-3">
                    ...
                    <a
                      routerLink="/pfm"
                      [queryParams]="{ tab: 'Goals' }"
                      class="text-xs text-[#00FF88] hover:underline"
                      >View all</a
                    >
                  </div>
                  <div class="space-y-3">
              ...
              <div>
                <div class="flex items-center justify-between mb-3">
                  <h2 class="text-sm" style="color: var(--text-3);">
                    Recent Activity
                  </h2>
                  <a
                    routerLink="/pfm"
                ...
                @if (recentTransactions().length) {
                      ...
                      >
                        ...
                        <div class="flex-1 min-w-0">
                          ...
                          <div
                            ...
                            style="color: var(--text-4);"
                          >
                            {{ t.description || (t.date | date: 'MMM d') }}
                          </div>
                        </div>
                        <div
                        ...
                        >
                          {{ t.type === 'Income' ? '+' : '-'
                            ...
                            t.amount | currency: 'USD' : 'symbol' : '1.0-0'
                          }}
                        </div>
                      </div>
                    }
                  ...
                  <div
                    class="rounded-2xl border p-6 text-center text-xs"
        ...
        @if (showModal) {
          ...
          >
            ...
            <div
              class="relative w-full max-w-[430px] bg-gray-900 border-t lg:border lg:rounded-3xl border-gray-700 rounded-t-3xl p-5 pb-8 animate-slide-up"
              (click)="$event.stopPropagation()"
            >
              <div
                class="w-10 h-1 bg-gray-600 rounded-full mx-auto mb-5 lg:hidden"
              ></div>
              ...
              @if (modalType === 'Expense' && goals.length) {
                ...
                <div class="mb-4">
                  ...
                  @if (selectedGoalId && txForm.value.amount) {
                    <div
                      class="mt-2 text-[11px] flex items-center gap-1.5"
                      style="color: #a78bfa;"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="mb-4">
                ...
                <div class="relative">
                  ...
                  <input
                    type="number"
                    [formControl]="txForm.controls.amount"
                    placeholder="0.00"
                    ...
                    [class]="
                      modalType === 'Expense'
                        ...
                        : 'focus:ring-[#00FF88]/50 focus:border-[#00FF88]/50'
                    "
                  />
                </div>
              </div>
              ...
              <div class="mb-5">
                ...
                <input
                  type="text"
                  [formControl]="txForm.controls.description"
              ...
              >
                @if (txSaving) {
                  <div
                    class="w-5 h-5 border-2 border-current border-t-transparent rounded-full animate-spin mx-auto"
                  ></div>
                } @else {
                  {{ modalType === 'Expense' ? 'Add Expense' : 'Add Income' }}
                }
              ...
              @if (
                !canSubmit() && !txSaving && (txForm.value.amount ?? 0) > 0
              ) {
                <p
                ...
                >
                  {{
                    modalType === 'Expense'
                      ? 'Pick a category or a goal to continue.'
        ...
        @if (showToast) {
          <div
            class="fixed top-6 left-1/2 -translate-x-1/2 z-50 max-w-[380px] w-full px-4"
          >
            <div
              class="flex items-center gap-3 px-4 py-3 rounded-2xl border shadow-xl backdrop-blur-xl"
              [class]="
                toastType === 'Income'
            ...
            >
              <div
                ...
                [class]="
                  toastType === 'Income' ? 'bg-[#00FF88]/20' : 'bg-red-500/20'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  stroke-linejoin="round"
                  [class]="
                    toastType === 'Income' ? 'text-[#00FF88]' : 'text-red-400'
                  "
                >
        ...
        @if (showExportToast) {
          ...
          >
            <div
              class="flex items-center gap-3 px-4 py-3 rounded-2xl border border-[#00FF88]/30 bg-[#00FF88]/10 shadow-xl backdrop-blur-xl"
            >
              <div
                class="w-8 h-8 rounded-full bg-[#00FF88]/20 flex items-center justify-center flex-shrink-0"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <span class="text-sm font-medium text-white"
                >Excel workbook downloaded</span
              >
            </div>
          </div>
        }
...
export class DashboardComponent implements OnInit {
  ...
  private loadAll() {
    const safe = <T>(o: any, fb: T) =>
      (o as any).pipe(catchError(() => of(fb)));
    forkJoin({
  ...
  submitTransaction() {
    ...
    this.api
      ...
      .subscribe({
        ...
        error: (err) => {
          this.txError =
            err.error?.error || 'Failed to save transaction. Please try again.';
          this.txSaving = false;
        },
      });
  }
